...
import MobileTrustCard from "./MobileTrustCard";
        ...
        <div className="relative flex flex-1 items-center justify-center">
          ...
          <div className="hidden lg:block">
            <FloatingCard
              ...
              className="absolute -left-12 bottom-24 z-20"
            />
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <Image
              ...
              height={980}
              priority
              className="h-auto w-[88%] max-w-md lg:w-full lg:max-w-2xl drop-shadow-[0_40px_80px_rgba(15,76,129,0.25)]"
            />
